...
Connection.prototype.sendOp = function(doc, op) {
  ...
  var message = {
    ...
    src: op.src,
    seq: op.seq,
    x: { transactionKey: op.transactionKey, opCount: op.opCount }
  };
...
Connection.prototype._getRandomString = function (len) {
...
Connection.prototype._newTransaction = function () {
  this._transactionKey = this._getRandomString(20);
  this._opCount = 1;
  var connection = this;
  util.nextTick(function () {
    connection._transactionKey = null;
  });
  return this._transactionKey;
};

Connection.prototype.getOpCount = function () {
  return this._opCount;
};

Connection.prototype.getTransactionKey = function () {
